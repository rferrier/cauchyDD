% 12/04/2018
% ID fissure 3D par chaîne de Markov
...
for iter = 1:niter
   ...
   mm{1} = [ theta(1),theta(2),theta(3) ; 0,1,0 ; 0,0,1 ]; rr{1} = [ -theta(4) ; 0 ; 0 ];
   mm{2} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,0,1 ]; rr{2} = [ -theta(4) ; 1 ; 0 ];
   mm{3} = [ theta(1),theta(2),theta(3) ; 0,1,0 ; 0,0,1 ]; rr{3} = [ -theta(4) ; 1 ; 0 ];
   mm{4} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,0,1 ]; rr{4} = [ -theta(4) ; 0 ; 0 ];

   mm{5} = [ theta(1),theta(2),theta(3) ; 0,1,0 ; 0,0,1 ]; rr{5} = [ -theta(4) ; 0 ; 1 ];
   mm{6} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,0,1 ]; rr{6} = [ -theta(4) ; 1 ; 1 ];
   mm{7} = [ theta(1),theta(2),theta(3) ; 0,1,0 ; 0,0,1 ]; rr{7} = [ -theta(4) ; 1 ; 1 ];
   mm{8} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,0,1 ]; rr{8} = [ -theta(4) ; 0 ; 1 ];

   mm{9}  = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,1,0 ]; rr{9}  = [ -theta(4) ; 0 ; 0 ];
   mm{10} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,1,0 ]; rr{10} = [ -theta(4) ; 1 ; 0 ];
   mm{11} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,1,0 ]; rr{11} = [ -theta(4) ; 1 ; 1 ];
   mm{12} = [ theta(1),theta(2),theta(3) ; 1,0,0 ; 0,1,0 ]; rr{12} = [ -theta(4) ; 0 ; 1 ];
