...
mat        = [0, E, nu];
br         = .0;      % Noise level
jmax       = 25;     % Eigenvalues truncation number
...
[ nodes2,elements2,ntoelem2,boundary2,order] = readmesh( 'meshes/rg_refined/plate_nn.msh' );
...
LhsC = zeros(nftest,2*nseg); % Decomposition functions are constant per segment
...
disp([ 'Crack Left hand side generated ', num2str(toc) ]);
tic
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
