...
// Crack construction
Point(9) = {a,b,H/2,lc2};
Point(10) = {a,b+R1*Cos(db),R1*Sin(db)+H/2,lc2};
Point(11) = {a-R1*Cos(da),b,-R1*Sin(da)+H/2,lc2};
Point(12) = {a,b-R1*Cos(db),H/2-R1*Sin(db),lc2};
Point(13) = {a+R1*Cos(da),b,R1*Sin(da)+H/2,lc2};
...
Point(14) = {a,b,H/2,lc2};
Point(15) = {a,b-R2*Cos(db),H/2-R2*Sin(db),lc2};
Point(16) = {a-R2*Cos(da),b,-R2*Sin(da)+H/2,lc2};
Point(18) = {a+R2*Cos(da),b,R2*Sin(da)+H/2,lc2};
