...
// Crack construction
Point(9) = {a,b,H/4,lc2};
Point(10) = {a,b+b1*Cos(db),H/4+b1*Sin(db),lc2};
Point(11) = {a-a1*Cos(da),b,-a1*Sin(da)+H/4,lc2};
Point(12) = {a,b-b1*Cos(db),H/4-b1*Sin(db),lc2};
Point(13) = {a+a1*Cos(da),b,a1*Sin(da)+H/4,lc2};
